...
import MTSSynthesis.controller.game.model.RankBasedLabelledGameSolver;
 ...
 */
public abstract class OppositeGRLabelledGameSolver<S,A> extends RankBasedLabelledGameSolver<S, A,Integer> {
	...
	public abstract GRLabelledGame<S,A> getGame();
