...
public class ChartTest {
	...
	public void testQtyLinearisations() {
		...
		assertEquals(1, this.createSeveralConditionsChart().getLinearisations().size());
		...
		assertEquals(2, this.createSeveralConditionsBeginingChartWithInteractionsA().getLinearisations().size());
		
		assertEquals(2, this.createSeveralConditionsBeginingChartWithInteractionsB().getLinearisations().size());
	}
	...
	public void testTwoLinearisationsWithInteractionsAndConditionsB() {
		...
		assertEquals(linearisations,this.createSeveralLinearisationsChartWithInteractionAndConditionsB().getLinearisations());
	}
